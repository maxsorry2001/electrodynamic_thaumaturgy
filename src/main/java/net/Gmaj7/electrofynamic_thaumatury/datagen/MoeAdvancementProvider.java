...
public class MoeAdvancementProvider extends AdvancementProvider {
    ...
    public static final class MoeAdvancementGenerator implements AdvancementProvider.AdvancementGenerator{
        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
            ...
            register(MoeBlocks.PHOTOVOLTAIC_ENERGY_MAKER_BLOCK, "normal", "energy_core", "energy_maker", "has_energy_maker", AdvancementType.TASK, consumer, existingFileHelper, MoeBlocks.PHOTOVOLTAIC_ENERGY_MAKER_BLOCK, MoeBlocks.TEMPERATURE_ENERGY_MAKER_BLOCK, MoeBlocks.THERMAL_ENERGY_MAKER_BLOCK);
