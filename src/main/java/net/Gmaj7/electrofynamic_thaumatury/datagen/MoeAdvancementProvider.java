    ...
    public static final class MoeAdvancementGenerator implements AdvancementProvider.AdvancementGenerator{
        ...
        public void generate(HolderLookup.Provider provider, Consumer<AdvancementHolder> consumer, ExistingFileHelper existingFileHelper) {
            ...
            builder.display(
                    ...
                    Component.translatable("advancements.electrofynamic_thaumatury.root.title"),
                    Component.translatable("advancements.electrofynamic_thaumatury.root.description"),
            ...
            register(MoeBlocks.PHOTOVOLTAIC_GENERATOR_BLOCK, "normal", "energy_core", "generator", "has_generator", AdvancementType.TASK, consumer, existingFileHelper, MoeBlocks.PHOTOVOLTAIC_GENERATOR_BLOCK, MoeBlocks.TEMPERATURE_GENERATOR_BLOCK, MoeBlocks.THERMAL_GENERATOR_BLOCK);
            ...
            register(MoeItems.ELECTROMAGNETIC_DRIVER_MACHINE_BLOCK.get(), "normal", "energy_core", "machine_block", "has_machine", AdvancementType.TASK, consumer, existingFileHelper, MoeBlocks.ELECTROMAGNETIC_DRIVER_MACHINE_BLOCK, MoeBlocks.BIO_REPLICATION_VAT_MACHINE_BLOCK);
