package net.Gmaj7.electrofynamic_thaumatury.MoeItem;
...
public class MoeItems {
    ...
    public static final Supplier<Item> MAGNETIC_RECOMBINATION_CANNON_MODULE = MOE_ITEM.register("magnetic_recombination_cannon_module",
    ...
    public static final Supplier<Item> FREQUENCY_DIVISION_ARROW_RAIN = MOE_ITEM.register("frequency_division_arrow_rain_module",
