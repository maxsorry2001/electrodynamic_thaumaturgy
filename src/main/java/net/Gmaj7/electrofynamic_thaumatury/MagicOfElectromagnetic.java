package net.Gmaj7.electrofynamic_thaumatury;
...
import net.Gmaj7.electrofynamic_thaumatury.MoeEntity.render.*;
import net.Gmaj7.electrofynamic_thaumatury.MoeGui.MoeMenuType;
import net.Gmaj7.electrofynamic_thaumatury.MoeInit.MoeAttachmentType;
...
import net.Gmaj7.electrofynamic_thaumatury.MoeParticle.custom.*;
...
public class MagicOfElectromagnetic
{
    ...
    public static final String MODID = "electrofynamic_thaumatury";
