package net.Gmaj7.electrofynamic_thaumatury.MoeGui;

import net.Gmaj7.electrofynamic_thaumatury.MagicOfElectromagnetic;
import net.Gmaj7.electrofynamic_thaumatury.MoeGui.menu.*;
...
public class MoeMenuType {
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<MoeEntityCloneBlockMenu>> ENTITY_CLONE_MENU = registerMenuType("entity_clone_menu", MoeEntityCloneBlockMenu::new);
