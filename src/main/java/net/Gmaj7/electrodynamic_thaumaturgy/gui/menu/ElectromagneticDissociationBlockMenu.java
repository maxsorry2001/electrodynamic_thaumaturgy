...
public class ElectromagneticDissociationBlockMenu extends AbstractContainerMenu {
    ...
    public ElectromagneticDissociationBlockMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
        super(EtMenuTypes.ELECTROMAGNETIC_DISSOCIATION_BLOCK_MENU.get(), containerId);
        this.blockEntity = (ElectromagneticDissociationBE) blockEntity;
        this.level = inventory.player.level();
        this.data = ((ElectromagneticDissociationBE) blockEntity).getData();
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EtBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE.get());
    }
