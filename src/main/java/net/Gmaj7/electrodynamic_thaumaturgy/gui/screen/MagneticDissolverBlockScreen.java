...
public class MagneticDissolverBlockScreen extends AbstractContainerScreen<MagneticDissolverBlockMenu> implements IEtDirectionItemScreen, IEtDirectionFluidScreen{
    ...
    public MagneticDissolverBlockScreen(MagneticDissolverBlockMenu menu, Inventory playerInventory, Component title) {
    ...
    public void extractRenderState(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        renderFluidWithTip(guiGraphics, menu.blockEntity.getFluidHandlerInput(), mouseX, mouseY, 0, x + 41, y + 18, 48, 16);
        renderFluidWithTip(guiGraphics, menu.blockEntity.getFluidHandlerOutput(), mouseX, mouseY, 0, x + 121, y + 18, 48, 16);
