...
public class EntityCloneBlockScreen extends AbstractContainerScreen<EntityCloneBlockMenu> {
    ...
    public EntityCloneBlockScreen(EntityCloneBlockMenu menu, Inventory playerInventory, Component title) {
