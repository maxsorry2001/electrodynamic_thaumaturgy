...
public class MagnetoEntropyWitchSummonEntity extends AbstractArrow {
    ...
    public MagnetoEntropyWitchSummonEntity(Level pLevel) {
        super(EtEntities.MAGNETO_ENTROPY_WITCH_SUMMON_ENTITY.get(), pLevel);
        this.pickup = Pickup.DISALLOWED;
    }
    ...
    public void tick() {
        ...
        if(summonTick < 0){
            MagnetoEntropyWitchEntity magnetoEntropyWitchEntity = EtEntities.MAGNETO_ENTROPY_WITCH_ENTITY.get().create(level(), EntitySpawnReason.SPAWNER);
    ...
    private void makeParticleA(){
        ...
        List<Vec3> circleXY45 = Function.rotatePointsYX(Function.getCirclePoints(40, 2), Mth.PI / 4, 0);
        List<Vec3> circleXY135 = Function.rotatePointsYX(Function.getCirclePoints(40, 2), -Mth.PI / 4, 0);
        List<Vec3> circleZY45 = Function.rotatePointsYX(Function.getCirclePoints(40, 2), Mth.PI / 4, Mth.PI / 2);
        List<Vec3> circleZY135 = Function.rotatePointsYX(Function.getCirclePoints(40, 2), -Mth.PI / 4, Mth.PI / 2);
    ...
    private void makeParticleB(){
        ...
        List<Vec3> polygon1 = Function.rotatePointsYX(Function.getPolygonVertices(3, 2, 0), Mth.PI / 2, 0),
                polygon2 = Function.rotatePointsYX(Function.getPolygonVertices(3, 2, Mth.PI), Mth.PI / 2, 0);
    ...
    private void makeParticleD(int tick, float dy, float radius){
        if(this.level().isClientSide()) return;
        List<Vec3> circle1 = Function.rotatePointsYX(Function.getCirclePoints((int) (10 * radius), radius), Mth.PI / 2, 0);
