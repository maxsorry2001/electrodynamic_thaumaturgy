...
public class EtRayEntity extends Entity implements IEntityWithComplexSpawn {
    public static final int time = 20;

    public float distance;


    public EtRayEntity(EntityType<?> entityType, Level level) {
        super(entityType, level);
    }

    public EtRayEntity(Level level, Vec3 start, Vec3 end, LivingEntity owner, boolean fromEntity) {
        super(EtEntities.ET_RAY_ENTITY.get(), level);
