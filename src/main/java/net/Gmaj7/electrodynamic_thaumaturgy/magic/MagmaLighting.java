...
public class MagmaLighting extends AbstractBlockBeaconMagic {
    ...
    private void makeCircleParticle(ServerLevel level, MagmaLightingBeaconEntity magmaLightingBeaconEntity, int height, double radius, float omega){
        ...
        for (int i = 0; i < point.size(); i++){
            ...
            level.sendParticles(new PointRotateParticleOption(center.toVector3f(), new Vector3f(height == 2 ? 255 : 128, height == 6 ? 255 : 128, height == 10 ? 255 : 128), new Vector3f(Mth.PI / 2, 0, omega), 20), pos.x(), pos.y(), pos.z(), 1, 0, 0, 0, 0);
        }
    }
    private void makeInParticle(ServerLevel level, MagmaLightingBeaconEntity magmaLightingBeaconEntity, int height, double radius, float omega){
        ...
        for (i = 0; i < polygon.size(); i++) {
            ...
            for (int j = 0; j < line.size(); j++) {
                ...
                level.sendParticles(new PointRotateParticleOption(center.toVector3f(), new Vector3f(height == 2 ? 255 : 128, height == 6 ? 255 : 128, height == 10 ? 255 : 128), new Vector3f(Mth.PI / 2, 0, omega), 20), pos.x(), pos.y(), pos.z(), 1, 0, 0, 0, 0);
                level.sendParticles(new PointRotateParticleOption(center.toVector3f(), new Vector3f(height == 2 ? 255 : 128, height == 6 ? 255 : 128, height == 10 ? 255 : 128), new Vector3f(Mth.PI / 2, 0, omega), 20), pos2.x(), pos2.y(), pos2.z(), 1, 0, 0, 0, 0);
            }
        }
    }
}
