...
public class TreeCurrent extends AbstractFrontEntityMagic {
    ...
    public void mobCast(LivingEntity source, LivingEntity target, ItemStack itemStack) {
        target.hurt(new DamageSource(MoeFunction.getHolder(source.level(), Registries.DAMAGE_TYPE, MoeDamageType.origin_thaumaturgy), source instanceof MagnetoOrderSageEntity ? ((MagnetoOrderSageEntity) source).getOwner() : source), MoeFunction.getMagicAmount(itemStack));
