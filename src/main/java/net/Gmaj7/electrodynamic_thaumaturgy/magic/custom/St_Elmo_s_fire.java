...
public class St_Elmo_s_fire extends AbstractSelfMagic{
    ...
    public void playerCast(Player livingEntity, ItemStack itemStack, MagicDefinition magicDefinition) {
        livingEntity.addEffect(new MobEffectInstance(EtEffects.ST_ELMO_S_FIRE, (int) (200 * Function.getEfficiency(itemStack)), (int) Function.getMagicAmount(itemStack)));
    ...
    public void mobCast(LivingEntity source, LivingEntity target, ItemStack itemStack, MagicDefinition magicDefinition) {
        source.addEffect(new MobEffectInstance(EtEffects.ST_ELMO_S_FIRE, (int) (200 * Function.getEfficiency(itemStack)), (int) Function.getMagicAmount(itemStack)));
