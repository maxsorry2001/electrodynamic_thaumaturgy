...
public class EtEffects {
    ...
    public static final DeferredHolder<MobEffect, MobEffect> ELECTRIC_ELECTRIC_RELEASE = EFFECTS.register("electric_energy_release",
            () -> new EtEffect(MobEffectCategory.BENEFICIAL, 0x666666)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED, Identifier.fromNamespaceAndPath(ElectrodynamicThaumaturgy.MODID, "moeeffect.emspeed"), 0.4, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_SPEED, Identifier.fromNamespaceAndPath(ElectrodynamicThaumaturgy.MODID, "moeeffect.easpeed"), 0.4, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    ...
    public static final DeferredHolder<MobEffect, MobEffect> NERVE_BLOCKING = EFFECTS.register("block_nerve",
            () -> new EtEffect(MobEffectCategory.HARMFUL, 0x0078AA)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED, Identifier.fromNamespaceAndPath(ElectrodynamicThaumaturgy.MODID, "moeeffect.bsspeed"), -0.15000000596046448, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    ...
    public static final DeferredHolder<MobEffect, MobEffect> PHOTO_CORROSIVE = EFFECTS.register("photo_corrosive",
            () -> new EtEffect(MobEffectCategory.HARMFUL, 0xFAF681)
                    .addAttributeModifier(Attributes.CORROSION, Identifier.fromNamespaceAndPath(ElectrodynamicThaumaturgy.MODID, "moeeffect.corrosion"), 0.25, AttributeModifier.Operation.ADD_VALUE));
