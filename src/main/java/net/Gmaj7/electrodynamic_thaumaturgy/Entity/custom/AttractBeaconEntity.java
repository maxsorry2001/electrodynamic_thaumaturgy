...
public class AttractBeaconEntity extends AbstractArrow {
    ...
    public AttractBeaconEntity(Level level){
        super(EtEntities.ATTRACT_BEACON_ENTITY.get(), level);
        this.pickup = Pickup.DISALLOWED;
    }
    ...
    protected void addAdditionalSaveData(ValueOutput output) {
        ...
        output.putInt("moe_live_time", this.liveTime);
    }

    @Override
    protected void readAdditionalSaveData(ValueInput input) {
        super.readAdditionalSaveData(input);
        this.liveTime = input.getInt("moe_live_time").get();
    }
    ...
    public void makeParticle(){
        ...
        List<Vec3> point = Function.rotatePointsYX(Function.getCirclePoints(30, 7), Mth.PI / 2, 0);
