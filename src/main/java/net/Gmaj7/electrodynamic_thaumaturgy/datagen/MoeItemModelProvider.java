...
public class MoeItemModelProvider extends ItemModelProvider {
    public MoeItemModelProvider(PackOutput output, ExistingFileHelper existingFileHelper) {
        super(output, ElectrodynamicThaumaturgy.MODID, existingFileHelper);
    }
    ...
    protected void registerModels() {
        ...
        basicItem(MoeItems.PRIMARY_POWER.get());
        basicItem(MoeItems.INTERMEDIATE_POWER.get());
        basicItem(MoeItems.ADVANCED_POWER.get());
        basicItem(MoeItems.SUPERCONDUCTING_POWER.get());
        basicItem(MoeItems.EMPTY_POWER.get());
        basicItem(MoeItems.PRIMARY_LC.get());
        basicItem(MoeItems.INTERMEDIATE_LC.get());
        basicItem(MoeItems.ADVANCED_LC.get());
