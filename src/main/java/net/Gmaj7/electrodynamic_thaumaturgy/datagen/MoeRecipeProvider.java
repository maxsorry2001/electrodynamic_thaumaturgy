...
public class MoeRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.COPPER_DUST, 2, Items.RAW_COPPER).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).saveWithAddition(output, "from_raw");
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.COPPER_DUST, 4, Tags.Items.ORES_COPPER).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).saveWithAddition(output, "from_ore_block");
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.IRON_DUST, 2, Items.RAW_IRON).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).saveWithAddition(output, "from_raw");
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.IRON_DUST, 4, Tags.Items.ORES_IRON).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).saveWithAddition(output, "from_ore_block");
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.GOLD_DUST, 2, Items.RAW_GOLD).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).saveWithAddition(output, "from_raw");
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.GOLD_DUST, 4, Tags.Items.ORES_GOLD).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).saveWithAddition(output, "from_ore_block");
        ElectromagneticDissociationRecipeBuilder.result(items, MoeItems.NETHERITE_DUST, 3, Tags.Items.ORES_NETHERITE_SCRAP).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output);
        ElectromagneticDissociationRecipeBuilder.result(items, Items.EMERALD, 3, Tags.Items.ORES_EMERALD).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Items.EMERALD, "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Items.COAL, 3, Tags.Items.ORES_COAL).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Items.COAL, "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Items.QUARTZ, 3, Tags.Items.ORES_QUARTZ).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Items.QUARTZ, "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Items.REDSTONE, 8, Tags.Items.ORES_REDSTONE).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Items.REDSTONE, "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Items.DIAMOND, 3, Tags.Items.ORES_DIAMOND).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Items.DIAMOND, "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Items.LAPIS_LAZULI, 3, Tags.Items.ORES_LAPIS).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Items.LAPIS_LAZULI, "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Blocks.SAND, Tags.Items.GRAVELS).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Blocks.SAND.asItem(), "from_ore_dissociation"));
        ElectromagneticDissociationRecipeBuilder.result(items, Blocks.GRAVEL, Tags.Items.COBBLESTONES).unlockedBy("has_dissociation", has(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE_BLOCK)).save(output, getVanillaItemWithAddition(Blocks.GRAVEL.asItem(), "from_ore_dissociation"));
    }
