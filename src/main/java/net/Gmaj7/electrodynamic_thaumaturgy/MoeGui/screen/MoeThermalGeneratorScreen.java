...
public class MoeThermalGeneratorScreen extends AbstractContainerScreen<MoeThermalGeneratorMenu> {
    ResourceLocation backGrand = ResourceLocation.fromNamespaceAndPath(ElectrodynamicThaumaturgy.MODID, "textures/gui/thermal_generator_block.png");
    ...
    ResourceLocation fireTexture = ResourceLocation.fromNamespaceAndPath(ElectrodynamicThaumaturgy.MODID, "textures/gui/fire.png");
