...
public class HarmonicSovereignEntityRender extends MobRenderer<HarmonicSovereignEntity, SovereignRenderState, HarmonicSovereignEntityModel<HarmonicSovereignEntity>> {
    ...
    @Override
    public void extractRenderState(HarmonicSovereignEntity entity, SovereignRenderState state, float partialTicks) {
        super.extractRenderState(entity, state, partialTicks);
        state.castAnimationState.copyFrom(entity.castAnimationState);
    }

    @Override
    public Identifier getTextureLocation(SovereignRenderState sovereignRenderState) {
        return TEX_LOCATION;
    }
}
