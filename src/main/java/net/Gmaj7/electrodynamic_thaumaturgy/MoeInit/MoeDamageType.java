...
public interface MoeDamageType {
    ...
    ResourceKey<DamageType> origin_thaumaturgy = ResourceKey.create(Registries.DAMAGE_TYPE, ResourceLocation.fromNamespaceAndPath(MagicOfElectromagnetic.MODID, "origin_thaumaturgy"));
}
