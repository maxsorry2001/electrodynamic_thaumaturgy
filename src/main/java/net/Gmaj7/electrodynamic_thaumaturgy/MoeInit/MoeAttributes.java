...
public class MoeAttributes {
    public static final DeferredRegister<Attribute> MOE_ATTRIBUTE = DeferredRegister.create(Registries.ATTRIBUTE, EelectrodynamicThaumaturgy.MODID);
    ...
    private static Holder<Attribute> rangeCreat(String name, int defaultNum, int min, int max){
        return MOE_ATTRIBUTE.register(name, () -> new RangedAttribute("attribute." + EelectrodynamicThaumaturgy.MODID + "." + name, defaultNum, min, max));
    }

    private static Holder<Attribute> percentRangeCreat(String name, int defaultNum, int min, int max, int scale){
        return MOE_ATTRIBUTE.register(name, () -> new PercentageAttribute("attribute." + EelectrodynamicThaumaturgy.MODID + "." + name, defaultNum, min, max, scale));
    }
