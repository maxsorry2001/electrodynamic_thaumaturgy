...
public class EtDataComponentTypes {
    ...
    public static final Supplier<DataComponentType<Integer>> ET_ENERGY =
            MOE_DATA_COMPONENT_TYPE.register("et_energy",
                    () -> DataComponentType.<Integer>builder().persistent(Codec.INT).build());

    public static final Supplier<DataComponentType<Integer>> MAGIC_SELECT =
            MOE_DATA_COMPONENT_TYPE.register("et_magic_slot",
                    () -> DataComponentType.<Integer>builder().persistent(Codec.INT).build());

    public static final Supplier<DataComponentType<EnhancementData>> ENHANCEMENT_DATA =
            MOE_DATA_COMPONENT_TYPE.register("et_enhancement_data",
    ...
    public static final Supplier<DataComponentType<BlockPos>> LINK_POS =
            MOE_DATA_COMPONENT_TYPE.register("et_link_pos",
    ...
    public static final Supplier<DataComponentType<ItemContainerContents>> ET_CONTAINER = MOE_DATA_COMPONENT_TYPE.register("et_container",
