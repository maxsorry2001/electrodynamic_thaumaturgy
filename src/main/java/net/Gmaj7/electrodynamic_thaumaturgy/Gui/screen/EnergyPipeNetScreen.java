...
import net.Gmaj7.electrodynamic_thaumaturgy.Gui.menu.EnergyPipeNetMenu;
...
public class EnergyPipeNetScreen extends PipeNetScreen<EnergyPipeNetMenu> {
    public EnergyPipeNetScreen(EnergyPipeNetMenu menu, Inventory inventory, Component title) {
