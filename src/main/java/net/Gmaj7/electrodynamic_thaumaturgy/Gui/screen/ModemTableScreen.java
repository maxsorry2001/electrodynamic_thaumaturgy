...
public class ModemTableScreen extends AbstractContainerScreen<ModemTableMenu> {
    ...
    public ModemTableScreen(ModemTableMenu menu, Inventory playerInventory, Component title) {
