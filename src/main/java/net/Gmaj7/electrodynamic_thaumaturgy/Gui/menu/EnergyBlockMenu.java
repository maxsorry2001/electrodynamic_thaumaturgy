...
public class EnergyBlockMenu extends AbstractContainerMenu {
    ...
    public EnergyBlockMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
        super(EtMenuTypes.ENERGY_BLOCK_MENU.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EtBlocks.ENERGY_BLOCK.get());
    }
