...
public class ElectromagneticExtractorBlockMenu extends AbstractContainerMenu {
    ...
    public ElectromagneticExtractorBlockMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
        super(EtMenuTypes.GEOLOGICAL_METAL_EXCAVATOR_MENU.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EtBlocks.ELECTROMAGNETIC_EXTRACTOR_MACHINE.get());
    }
