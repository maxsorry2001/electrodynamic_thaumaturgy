...
public class ElectromagneticDriverBlockMenu extends AbstractContainerMenu {
    ...
    public ElectromagneticDriverBlockMenu(int containerId, Inventory inventory, BlockEntity blockEntity) {
        super(EtMenuTypes.ELECTROMAGNETIC_DRIVER_MACHINE_MENU.get(), containerId);
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EtBlocks.ELECTROMAGNETIC_DRIVER_MACHINE.get());
    }
