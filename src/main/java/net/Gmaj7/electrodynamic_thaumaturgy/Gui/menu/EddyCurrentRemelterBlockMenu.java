...
public class EddyCurrentRemelterBlockMenu extends AbstractContainerMenu {
    ...
    public EddyCurrentRemelterBlockMenu(int containerId, ContainerLevelAccess access, Inventory inventory, BlockEntity blockEntity) {
        super(EtMenuTypes.EDDY_CURRENT_REMELTER_BLOCK_MENU.get(), containerId);
        this.access = access;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, EtBlocks.EDDY_CURRENT_REMELTER_MACHINE.get());
    }
