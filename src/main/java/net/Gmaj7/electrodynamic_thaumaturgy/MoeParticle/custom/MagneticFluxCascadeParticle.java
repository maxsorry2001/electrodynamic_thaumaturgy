...
public class MagneticFluxCascadeParticle extends TextureSheetParticle {
    private final SpriteSet spriteSet;
    public MagneticFluxCascadeParticle(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
    ...
    public float getQuadSize(float scaleFactor) {
        if(this.age <= 5) return (float) (0.2 * this.age);
        else return (float) (0.2 * (11 - this.age));
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>{
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double xv, double yv, double zv) {
            return new MagneticFluxCascadeParticle(clientLevel, x, y, z, spriteSet);
        }
    }
}
