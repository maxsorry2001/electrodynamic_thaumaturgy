...
public class MagmaLightingParticleSmallIn extends TextureSheetParticle {
    private final SpriteSet spriteSet;
    public MagmaLightingParticleSmallIn(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
    ...
    public float getQuadSize(float scaleFactor) {
        return this.quadSize * Math.min(this.age, 10);
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>{
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double xv, double yv, double zv) {
            return new MagmaLightingParticleSmallIn(clientLevel, x, y, z, spriteSet);
        }
    }
}
