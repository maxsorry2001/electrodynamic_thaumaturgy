    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> MOE_TAB = MOE_CREATIVE_TABS.register("moe_tab",
            () -> CreativeModeTab.builder().icon(() -> setFullEnergyItem(getDefaultMagicUse(MoeItems.ELECTROMAGNETIC_ROD.get())))
                    ...
                    .displayItems(((itemDisplayParameters, output) -> {
                        ...
                        output.accept(MoeBlocks.TEMPERATURE_GENERATOR);
                        output.accept(MoeBlocks.PHOTOVOLTAIC_GENERATOR);
                        output.accept(MoeBlocks.BIOMASS_GENERATOR);
                        output.accept(MoeBlocks.THERMAL_GENERATOR);
                        output.accept(MoeBlocks.ELECTROMAGNETIC_DRIVER_MACHINE);
                        output.accept(MoeBlocks.BIO_REPLICATION_VAT_MACHINE);
                        output.accept(MoeBlocks.ELECTROMAGNETIC_EXTRACTOR_MACHINE);
                        output.accept(MoeBlocks.ATOMIC_RECONSTRUCTION_MACHINE);
                        output.accept(MoeBlocks.MAGNETO_FUSION_MACHINE);
                        output.accept(MoeBlocks.ELECTROMAGNETIC_DISSOCIATION_MACHINE);
                        output.accept(MoeBlocks.EDDY_CURRENT_REMELTER_MACHINE);
                        output.accept(MoeBlocks.ELECTROMAGNETIC_INFUSER_MACHINE);
                        output.accept(MoeBlocks.ENERGY_TRANSMISSION_ANTENNA);
                        output.accept(MoeBlocks.MAGNETO_CORE);
