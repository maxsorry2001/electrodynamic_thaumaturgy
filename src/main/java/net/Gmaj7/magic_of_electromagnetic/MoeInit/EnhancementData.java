...
public record EnhancementData(float strength, float coolDown, float efficiency, int potential_difference, int bioelectricStop, int entropy) {
    public static final EnhancementData defaultData = new EnhancementData(1F, 1F, 1F, 0, 0, 0);
