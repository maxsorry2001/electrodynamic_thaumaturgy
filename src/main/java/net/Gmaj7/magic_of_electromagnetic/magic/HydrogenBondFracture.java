    ...
    public void cast(LivingEntity livingEntity, ItemStack itemStack) {
        ...
        if(level instanceof ServerLevel){
            ...
            for (int i = 0; i < 10; i++){
                ...
                ((ServerLevel) level).sendParticles(MoeParticles.HYDROGEN_BOND_PARTICLE.get(), target.getX() + 4 * randomSource.nextFloat(), target.getY() + 1 + randomSource.nextFloat(), target.getZ() + 4 * randomSource.nextFloat(), 5, 0, 0, 0, 0);
            }
        }
    }
