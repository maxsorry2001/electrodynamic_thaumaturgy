...
public class MoeBlockEntities {
    ...
    public static final Supplier<BlockEntityType<TemperatureEnergyMakerBlockEntity>> ENERGY_MAKER_BLOCK_BE =
            MOE_BLOCK_ENTITY.register("temperature_energy_maker_block_be", () -> BlockEntityType.Builder.of(
                    TemperatureEnergyMakerBlockEntity::new, MoeBlocks.ENERGY_MAKER_BLOCK.get()).build(null));
