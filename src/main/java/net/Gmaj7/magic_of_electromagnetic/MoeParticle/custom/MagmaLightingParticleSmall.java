...
public class MagmaLightingParticleSmall extends TextureSheetParticle {
    private final SpriteSet spriteSet;
    public MagmaLightingParticleSmall(ClientLevel level, double x, double y, double z, SpriteSet spriteSet) {
        super(level, x, y, z);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType>{
        ...
        public Particle createParticle(SimpleParticleType simpleParticleType, ClientLevel clientLevel, double x, double y, double z, double xv, double yv, double zv) {
            return new MagmaLightingParticleSmall(clientLevel, x, y, z, spriteSet);
        }
    }
}
